...
Do.add('yx_rotaion',{
    type : 'js',
    path : basedir + 'jquery.yx_rotaion.js'
});
...
(function(window) {
    ...
    Do('jquery','placeholder','form','lazyload',function() {
        ...
        if($('.hj-picScroll-left,.plot-slider').length > 0){
            //轮播
        ...
        if($('.k-dialog-type-1, .k-dialog-type-2,.k-cal-1,.k-cal-2,.k-cal-3,.k-cal-4,.kanfangform,.ui-question-form,.k-dialog-phone').length > 0){
