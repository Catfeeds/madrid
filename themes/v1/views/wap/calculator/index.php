...
Yii::app()->clientScript->registerCssFile(Yii::app()->baseUrl.'/static/wap/style/calculator.css');
 $this->registerHeadJs(['jquery.min','640resize','libs/zepto.min','validform.min','layout']);
 $this->registerEndJs(['main']);
$this->pageTitle = '商业贷款计算器';
?>
<div class="ui-wrapper" style="width:100%">
        ...
        <div class="ui-tab-con">
                    ...
                    <div class="bg-fff">
                        <ul class="ui-list ui-list-arrows mt20 bb0 single-calc" style="display:none">
                            <li class="ui-list-item no-arrows">
                                ...
                                <div class="unit">元/m<sup>2</sup></div>
                            </li>
                            <li class="ui-list-item no-arrows">
                        ...
                        <ul class="ui-list ui-list-arrows mt20 bb0" style="border-top:0;">
                            ...
                            <li class="ui-list-item no-arrows">
                                ...
                                <div class="ui-form-controls ui-custom-select js-rate">
                                    <input id="sy-lv" type="text" class="ui-input-text" data-type="/^[0-9]+(\.[0-9]+)?$/" data-null="请设置银行利率" data-error="请填写正确的银行利率" value="4.9" rate1="4.9" rate2="4.9" rate3="4.9">
                                    <select name="" class="">
                                        <!-- rate值是由后台传过来的利率 -->
                                        <!-- rat1:小于5年利率 rate2:五年以上利率 -->
                                        <option value="0" rate1="4.9" rate2="4.9" rate3="4.9" selected="selected">2015年10月24日 基准利率</option>
                                        <option value="1" rate1="5.15" rate2="5.15" rate3="5.15">2015年8月26日 基准利率</option>
                                        <option value="2" rate1="5.4" rate2="5.4" rate3="5.4">2015年6月28日 基准利率</option>
                                        <option value="3" rate1="5.65" rate2="5.65" rate3="5.65">2015年5月11日 基准利率</option>
                                        <option value="5" rate1="5.9" rate2="5.9" rate3="5.9">2015年3月1日 基准利率</option>
                                    </select>
                    ...
                    <div class="bg-fff">
                            ...
                            <li class="ui-list-item no-arrows">
                                ...
                                <div class="ui-form-controls ui-custom-select js-rate">
                                    ...
                                    <select name="" class="">
                                        <!-- rate值是由后台传过来的利率 -->
                                        <!-- rat1:小于5年利率 rate2:五年以上利率 -->
                                        <option value="0" rate1="3.25" rate2="3.25" rate3="3.25" selected="selected">2015年8月26日 基准利率</option>
                                        <option value="1" rate1="3.5" rate2="3.5" rate3="3.5">2015年6月28日 基准利率</option>
                                        <option value="2" rate1="3.75" rate2="3.75" rate3="3.75">2015年5月11日 基准利率</option>
                                        <option value="3" rate1="4.0" rate2="4.0" rate3="4.0">2015年3月1日 基准利率</option>
                                    </select>
                                </div>
                                <div class="persent" >%<a href="javascript:;"><span>修改</span></a></div>
                            </li>
                        ...
                        <div class="js-return-way">
                            <ul class="ui-list mt20 bb0 way-tag">
                                <li class="ui-list-item">
                                    <div class="ui-form-field">还款方式</div>
                                    <div class="ui-form-controls" style="font-size:30px;">
                                        <label class="ui-form-label bx"><input type="radio" name="return-way" class="ui-input-radio"  checked on=1>等额本息</label>
                                        <label class="ui-form-label bj"><input type="radio" name="return-way" class="ui-input-radio" value="0" on=0>等额本金</label>
                                    </div>
                                </li>
                    ...
                    <div class="bg-fff">
                        ...
                        <ul class="ui-list ui-list-arrows mt20 bb0">
                            ...
                            <li class="ui-list-item no-arrows">
                                ...
                                <div class="ui-form-controls ui-custom-select js-rate">
                                    ...
                                    <select name="" class="">
                                        <!-- rate值是由后台传过来的利率 -->
                                        <!-- rat1:小于5年利率 rate2:五年以上利率 -->
                                        <option value="0" rate1="3.25" rate2="3.25" rate3="3.25" selected="selected">2015年10月24日 基准利率</option>
                                        <option value="1" rate1="3.25" rate2="3.25" rate3="3.25">2015年8月26日 基准利率</option>
                                        <option value="2" rate1="3.5" rate2="3.5" rate3="3.5">2015年6月28日 基准利率</option>
                                        <option value="3" rate1="3.75" rate2="3.75" rate3="3.75">2015年5月11日 基准利率</option>
                                        <option value="4" rate1="4.0" rate2="4.0" rate3="4.0">2015年3月1日 基准利率</option>
                                    </select>
                            ...
                            <li class="ui-list-item no-arrows">
                                ...
                                <div class="ui-form-controls ui-custom-select js-rate">
                                    <input id="zh-sy-lv" type="text" class="ui-input-text" data-type="/^[0-9]+(\.[0-9]+)?$/" data-null="请设置商业利率" data-error="请填写正确的商业利率" value="4.9" rate1="4.9" rate2="4.9" rate3="4.9">
                                    <select name="" class="">
                                        <!-- rate值是由后台传过来的利率 -->
                                        <!-- rat1:小于5年利率 rate2:五年以上利率 -->
                                        <option value="0" rate1="4.9" rate2="4.9" rate3="4.9" selected="selected">2015年10月24日 基准利率</option>
                                        <option value="1" rate1="5.15" rate2="5.15" rate3="5.15">2015年8月26日 基准利率</option>
                                        <option value="2" rate1="5.4" rate2="5.4" rate3="5.4">2015年6月28日 基准利率</option>
                                        <option value="3" rate1="5.65" rate2="6.65" rate3="6.65">2015年5月11日 基准利率</option>
                                        <option value="4" rate1="5.9" rate2="5.9" rate3="5.9">2015年3月1日 基准利率</option>
                                    </select>
            ...
            <div class="ui-tab-item">
                <form id="sfjs-form" class="ui-form form" action="" >
                    <div class="bg-fff" >
                        <ul class="ui-list ui-list-arrows mt20 single-calc">
                            <li class="ui-list-item no-arrows">
                                <div  class="ui-form-field">单&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价</div>
...
<div class="wrap calc-result" style="display:none;">
    <header class="ui-title-bar wrap">
        <a href="javascript:;" class="back" href="javascript:;" onclick="$('.calc-main').show();$('.calc-result').hide();" ><i class="icon icon-black-arrow"></i></a>
        <h1 id="js-calc-tit">计算结果</h1>
    </header>
    <div class="ui-form bg-fff">
        ...
        <div class="result-tip content-wrap">结果超出预算啦？您可以尝试调整按揭年数，或者找西子房产抢优惠！</div>
        <div class="ui-btn-wrap">
            <a href="javascript:;" class="ui-btn ui-btn-danger"  onclick="$('.calc-main').show();$('.calc-result').hide();" >重新计算</a>
        </div>
    </div>
</div>
<div class="wrap calc-result2" style="display:none;">
    <header class="ui-title-bar wrap">
        <a href="javascript:;" class="back" href="javascript:;" onclick="$('.calc-main').show();$('.calc-result2').hide();" ><i class="icon icon-black-arrow"></i></a>
        <h1 id="js-calc-tit2">计算结果</h1>
    </header>
    <div class="ui-form bg-fff">
        <ul class="ui-list ui-list-arrows mt20 bb0">
            <li class="ui-list-item no-arrows total-calc">
                <div class="ui-form-field fs24">房款总价</div>
                ...
                <div class="unit fs24">&nbsp;&nbsp;&nbsp;&nbsp;元</div>
            </li>
            <li class="ui-list-item no-arrows total-calc">
                <div class="ui-form-field fs24">契税</div>
            ...
            <li class="ui-list-item no-arrows total-calc">
                <div class="ui-form-field fs24">印花税</div>
        ...
        <ul class="ui-list mt20 bb0">
            <li class="ui-list-item no-arrows total-calc">
                <div class="ui-form-field fs24">公证费</div>
            ...
            <li class="ui-list-item no-arrows total-calc">
                <div class="ui-form-field fs24">房屋买卖手续费</div>
        ...
        <div class="ui-btn-wrap">
            <a href="javascript:;" class="ui-btn ui-btn-danger"  onclick="$('.calc-main').show();$('.calc-result2').hide();" >重新计算</a>
        </div>
    </div>
</div>
<script>
