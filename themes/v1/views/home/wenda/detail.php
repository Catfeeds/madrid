...
if($ask->cate){
    $this->breadcrumbs = array($this->siteConfig['cityName'].'问答'=>$this->createUrl('index'),$ask->cate->name=>$this->createUrl('index',array('cid'=>$ask->cate->id)),'问答详情页');
}else{
    $this->breadcrumbs = array($this->siteConfig['cityName'].'问答'=>$this->createUrl('index'),'问答详情页');
}
