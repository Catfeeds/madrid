<?php
 ...
 $this->breadcrumbs = array($this->siteConfig['cityName'].'邻校房'=>$this->createUrl('index'),$school->areaInfo->name.'邻校房'=>$this->createUrl('area',array('id'=>$school->areaInfo->id)), $school->name.'邻校房');
?>
