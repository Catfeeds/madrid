...
<head>
    ...
    <meta name="Keywords" content="<?php echo $this->siteConfig['cityName'].'地图找房，'.$this->siteConfig['cityName'].'楼盘地图，'.$this->siteConfig['cityName'].'房产地图，'.$this->siteConfig['cityName'].'新房中心，'.$this->siteConfig['cityName'].'房价，'. $this->siteConfig['siteName'].'房产';?>"/>
    <meta name="Description" content="<?php echo $this->siteConfig['siteName'].'房产网为广大网友提供最新最全的'.$this->siteConfig['cityName'].'楼盘地图、'.$this->siteConfig['cityName'].'房产地图、'.$this->siteConfig['cityName'].'楼盘房价，方便大家更清晰、更准确了解买房信息，'.$this->siteConfig['cityName'].'地图找房就来'.$this->siteConfig['siteName'].'房产网';?>"/>
    <meta http-equiv="X-UA-Compatible" content="IE=7, IE=Edge">
    <title><?php echo $this->siteConfig['cityName'].'地图找房_'.$this->siteConfig['cityName'].'楼盘地图_'.$this->siteConfig['cityName'].'房产地图-'.$this->siteConfig['siteName'].'房产-'.$this->siteConfig['siteName'];?></title>
...
<div class="wapperout s-head-bg clearfix">
    <div class="s-head ml10">
        <a href="/" target="_blank" class="fl s-head-logo">
            <?php if($this->siteConfig['siteLogoRed']): ?><img src="<?php echo ImageTools::fixImage($this->siteConfig['siteLogoRed']); ?>"><?php endif; ?></a>
        <ul class="s-head-nav">
...
<div class="wapperout d-pink-bg">
    <div class="p_current fs14 fl ml10">当前位置：<a href="<?php echo $this->createUrl('/home/index/index'); ?>" target="_blank"><?php echo $this->siteConfig['cityName']; ?>房产</a>&gt;<a href="<?php echo $this->createUrl('/home/plot/list'); ?>" target="_blank"><?php echo $this->siteConfig['cityName']; ?>新房</a>&gt;<span>地图找房</span></div>
        ...
        <div class="inforight">
            <dl>
                ...
                <dd>
                    ...
                    <a class="search_area search_left_condition" data-lng="<?php echo $v->map_lng; ?>" data-lat="<?php echo $v->map_lat; ?>"><?php echo $v->name; ?></a>
                    <?php endforeach; ?>
                </dd>
            </dl>
            <div class="clear"></div>
        ...
        <div class="inforight">
            <dl>
                ...
                <dd>
                    ...
                    <?php foreach(PlotPricetagExt::model()->normal()->findAll() as $v): ?>
                    <a class="search_price search_left_condition" data-id="<?php echo $v->id?>"><?php echo $v->title; ?></a>
                    <?php endforeach;?>
                </dd>
            </dl>
            <div class="clear"></div>
...
<script>
    ...
    var cityName = "<?php echo $this->siteConfig['cityName']; ?>";
...
<script src="<?php echo Yii::app()->baseUrl; ?>/static/home/js/map_common.js?v=2014723"></script>
<script src="<?php echo Yii::app()->baseUrl; ?>/static/home/js/map_plot_search.js?v=2014723"></script>
</html>
