...
<script type="text/javascript">
	...
	var map = new BMap.Map("allmap");	
        ...
        var _initPoint = new BMap.Point(<?php echo $school->map_lng?>, <?php echo $school->map_lat?>);
        map.centerAndZoom(_initPoint,14);
        <?php if(isset($school) && !empty($school)){ ?>
            var marker1 = new BMap.Marker(new BMap.Point(<?php echo $school->map_lng?>, <?php echo $school->map_lat?>)); 
            ...
            addfunc(" <?php echo $school->name ?><br><br>电话： <?php echo $school->phone ?> <br>地址： <?php echo $school->address ?>");           
        <?php }?>            
