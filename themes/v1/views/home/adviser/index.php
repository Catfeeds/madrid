...
?>
    ...
    <div class="wapperout">
        <div class="dabai-content">
            <div class="wapper">
                <div class="dabai-l">
                    <?php echo $this->siteConfig['adviserPageMascot'] ? CHtml::Image(ImageTools::fixImage($this->siteConfig['adviserPageMascot']),'',['class'=>'dabai-img']):'' ?>
                    <div class="title dabai-ico">
                        <p class="big-title"><?php echo $this->siteConfig['siteName']; ?>买房顾问</p>
                    ...
                    <div class="txtMarquee-top">
                        ...
                        <div class="bd">
                            <ul class="infoList">
                                ...
                                <li><span><?php echo $this->hideName($v->name); ?></span><span><?php echo substr_replace($v->phone,'****',3,4); ?></span><span><?php echo $v->getPlot() ? $v->getPlot()->title : '-'; ?></span><span><?php echo Tools::friendlyDate($v->created); ?></span></li>
                                <?php endforeach;?>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="advantage-list">
                <ul>
                    ...
                    <li class="li2">
                        ...
                        <p class="desc"><?php echo $this->t('房大白'); ?>全程讲解 带你看遍<?php echo $this->siteConfig['cityName']; ?></p>
                    </li>
                    <li class="li3">
                        <p class="title dabai-ico">优惠</p>
                        <p class="desc">与<?php echo $this->siteConfig['cityName'].PlotExt::model()->isNew()->normal()->count(); ?>余项目亲密合作</p>
                        <p class="desc">底价+购房红包给你实实在在的实惠</p>
                    </li>
                    <li class="li4">
                        <p class="title dabai-ico">公信</p>
                        <p class="desc">计件制薪资向您承诺</p>
                ...
                <ul class="team-list">
                    ...
                    <li>
                        ...
                        <div class="info">
                            ...
                            <p class="time">从事<?php echo $this->siteConfig['cityName']; ?>房产行业<span> <?php echo $v->work_time; ?> </span>年</p>
