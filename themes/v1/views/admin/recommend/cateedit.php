...
<div class="portlet-body">
    ...
    <div class="form-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <?php echo $form->dropDownList($model,'parent',CHtml::listData(Tools::menuMake($this->recomCate,-1,'id'),'id','name'),array('class'=>'form-control','encode'=>false,'disabled'=>!$model->isNewRecord, 'empty'=>array(0=>'--根节点--'))) ?>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4 radio-list">
                <?php echo $form->radioButtonList($model, 'status', RecomCateExt::$status, array('separator'=>'','template'=>'<label>{input} {label}</label>')); ?>
            </div>
        </div>
