...
<head>
<meta charset="utf-8"/>
<title><?php echo $this->pageTitle='房产管理后台登录' ?></title>
...
<!-- BEGIN LOGO -->
<div class="logo">
    <?php if(!empty($this->siteConfig['loginLogo'])): ?>
        <img src="<?php echo ImageTools::fixImage($this->siteConfig['loginLogo']); ?>" alt="">
    <?php else: ?>
...
<div class="content ">
	...
	<form class="login-form" action="" method="post">
		<h3 class="form-title" style="font-family: 微软雅黑">房产管理后台</h3>
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
	 2015 &copy; <?php echo $this->siteConfig['siteName'] ?>版权所有
</div>
<!-- END COPYRIGHT -->
...
Layout.init(); // init current layout
  ...
  Demo.init();
       ...
       $.backstretch([
        ...
        "/static/admin/pages/media/bg/5.jpg",
        ], {
          fade: 1000,
          duration: 3000
    }
