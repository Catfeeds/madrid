        ...
        <tr>
            ...
            <td style="text-align:center;vertical-align: middle">
                <div class="btn-group btn-group-xs btn-group-solid">
                    <a class="label label-primary" onclick="do_admin($(this))" data-url="<?php echo $this->createUrl('/admin/plot/pricelist',array('hid'=> $v->id)) ?>">价格动态</a><span class="label bg-blue-chambray"><?php echo PlotPriceExt::getCountByhid($v->id);?></span>
                </div>
                <div class="btn-group btn-group-xs btn-group-solid">
                    <a href="javascript:;" class="label label-success" onclick="do_admin($(this))" data-url="<?php echo $this->createUrl('/admin/plot/imagelist',array('hid'=> $v->id)) ?>">图片相册</a><span class="label bg-blue-chambray"><?php echo PlotImgExt::getCountByhid($v->id);?></span>
                </div>
                <div class="btn-group btn-group-xs btn-group-solid">
                    <a href="javascript:;" class="label label-primary" onclick="do_admin($(this))" data-url="<?php echo $this->createUrl('/admin/plot/deliverylist',array('hid'=> $v->id)) ?>">交房时间</a><span class="label bg-blue-chambray"><?php echo PlotDeliveryExt::getCountByhid($v->id);?></span>
                </div>
                <div class="btn-group btn-group-xs btn-group-solid">
                    <a href="javascript:;" class="label bg-blue-hoki" onclick="do_admin($(this))" data-url="<?php echo $this->createUrl('/admin/plot/discountlist',array('hid'=> $v->id)) ?>">优惠信息</a><span class="label bg-blue-chambray"><?php echo PlotDiscountExt::getCountByhid($v->id);?></span>
                </div>
            </td>
            <td style="text-align:center;vertical-align: middle">
