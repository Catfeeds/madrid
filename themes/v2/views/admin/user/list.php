...
<form method="get" action="">
    ...
    <div class="table-toolbar form-inline">
        ...
        <div class="btn-group pull-right">
            <!-- <div class="form-group">
                <a class="btn green" onclick="do_admin($(this))" data-url="">导入用户</a>
            </div> -->
            <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="note note-success">
                    ...
                    <p>
                         请按照样表的规则进行填表。</br>
                          必填字段：<span style="color: red">【手机号】【姓名】【订单来源类型】</span></br>
                ...
                <form action="<?=$this->createUrl('order/list')?>" enctype="multipart/form-data" method="post">
                    ...
                    <?php echo CHtml::dropDownList('staff_id', 0, CHtml::listData(StaffExt::model()->normal()->findAll(),'id','username'), array('empty'=>array(0=>'--请选择买房顾问--'),'class'=>'form-control input-inline'));?>
                   </div>
