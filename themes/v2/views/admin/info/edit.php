...
<div class="form-group">
	<label class="col-md-2 control-label">短标题</label>
	<div class="col-md-4">
		<?php echo $form->textField($article, 's_title', array('class'=>'form-control')); ?>
	</div>
	<div class="col-md-2"><?php echo $form->error($article, 's_title') ?></div>
</div>
<div class="form-group">
    <label class="col-md-2 control-label">分类</label>
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'cid', CHtml::listData(Tools::menuMake(ArticleCateExt::model()->normal()->findAll()), 'id', 'name'), array('class' => 'form-control', 'encode' => false)); ?>
    </div>
...
<div class="form-group">
    ...
    <div class="col-md-6">
        <?php echo $form->multiAutocomplete($article, 'plot',$datasel,$this->createUrl('/admin/plot/ajaxGetHouse'), array('class'=>'form-control'));  ?>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-8">
        <?php echo $form->textArea($article, 'description', array('class' => 'form-control')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'description') ?></div>
</div>
...
<div class="form-group">
	...
	<div class="col-md-6">
		<div id="uploader1" class="wu-example">
		   <div class="btns">
			  <?php $this->widget('FileUpload',array('model'=>$article,'attribute'=>'image','inputName'=>'image','removeCallback'=>"$('#cover_img').html('')")); ?>
		   </div>
		</div>
		<div id="singlePicyw1"></div>
	 </div>
	<div class="col-md-2"><?php echo $form->error($article, 'image') ?></div>
</div>
<div class="form-group">
    <label class="col-md-2 control-label"><?php echo $form->labelEx($article,'keywords_switch');?></label>
    <div class="col-md-4">
        <?php echo $form->radioButtonList($article, 'keywords_switch', ArticleExt::$keywordsSwitch, array('separator' => '')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'keywords_switch') ?></div>
</div>
<div class="form-group">
    <label class="col-md-2 control-label"><?php echo $form->labelEx($article,'show_time');?></label>
    <div class="col-md-3">
        <div class="input-group date form_datetime">
            <?php echo $form->textField($article,'show_time',array('class'=>'form-control gather_time','value'=>($article->show_time ? date('Y-m-d H:i', $article->show_time) : ''))); ?>
...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $form->textField($article, 'seo', array('class'=>'form-control')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'seo')  ?></div>
</div>
<div class="form-group">
    <label class="col-md-2 control-label">标签</label>
    <div class="col-md-4">
        <?php echo $form->textField($article, 'tag', array('class'=>'form-control')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'tag')  ?></div>
</div>
<div class="form-group">
    <label class="col-md-2 control-label">转向链接</label>
    <div class="col-md-4">
        <?php echo $form->textField($article, 'url', array('class' => 'form-control' ,  'placeholder'=>'输入的网址请以http://开头')); ?>
    </div>
...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $form->radioButtonList($article, 'data_conf[isAd]', [0=>'否',1=>'是'], array('separator' => '')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'data_conf[isAd]') ?></div>
</div>
<div class="form-actions">
    <div class="row">
        <div class="col-md-offset-3 col-md-9">
            ...
            <button type="botton" name="goto" value="1" class="btn green">保存并推荐</button>
        </div>
    </div>
</div>
