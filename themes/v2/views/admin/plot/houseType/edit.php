...
<div class="portlet-body">
    ...
    <div class="form-body">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                <div class="margin-bottom-10">
                    <?= $form->textField($model, 'bedroom', array('class'=>'form-control input-inline')).'室'.$form->textField($model, 'livingroom', array('class'=>'form-control input-inline')).'厅'; ?>
                </div>
                <div class="margin-top-10">
                    <?=$form->textField($model, 'bathroom', array('class'=>'form-control input-inline')).'卫'.$form->textField($model, 'cookroom', array('class'=>'form-control input-inline')).'厨'; ?>
                </div>
            </div>
        ...
        <div class="form-group">
            <label class="col-xs-2 control-label">建筑面积</span></label>
            <div class="col-xs-5">
        ...
        <div class="form-group">
            <label class="col-xs-2 control-label">套内面积</span></label>
            <div class="col-xs-5">
                <?php echo $form->textField($model, 'inside_size', array('class'=>'form-control input-inline')); ?>㎡
            </div>
            <div class="col-xs-4"><?php echo $form->error($model, 'inside_size') ?></div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="col-xs-2 control-label">均价</span></label>
            <div class="col-xs-5">
                <?php echo $form->textField($model, 'ave_price', array('class'=>'form-control input-inline')); ?>元/㎡
            </div>
            <div class="col-xs-4"><?php echo $form->error($model, 'ave_price') ?></div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-5">
                <?php $this->widget('FileUpload',array('model'=>$model, 'attribute'=>'image','waterMark'=>true,'mode'=>2,'width'=>300)) ?>
            </div>
