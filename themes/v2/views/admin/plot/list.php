    ...
    <?php foreach($list as $k=>$v): ?>
        <tr>
            ...
            <td style="text-align:center;vertical-align: middle">
                ...
                <div class="btn-group btn-group-xs btn-group-solid">
                    <a href="javascript:;" class="label label-primary" onclick="do_admin($(this))" data-url="<?php echo $this->createUrl('evaluate',array('hid'=> $v->id)) ?>">楼盘评测</a>
                </div>
                <div class="btn-group btn-group-xs btn-group-solid">
                ...
                <div class="btn-group">
					<button class="btn red btn-xs dropdown-toggle" data-toggle="dropdown" style="cursor:pointer;">更多<i class="fa fa-angle-down"></i>
					</button>
					<ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="javascript:;" onclick="do_admin($(this))" data-url="<?php echo $this->createUrl('videoList',array('hid'=>$v->id))?>">楼盘视频</a></li>
					</ul>
				</div>
            </td>
            <td style="text-align:center;vertical-align: middle">
