...
<div class="table-toolbar">
    <div class="btn-group pull-right">
        <?php echo CHtml::link('添加价格动态 <i class="fa fa-plus"></i>', $this->createUrl('plot/priceTagedit'),array('class'=>'btn green'));
        ?>
    </div>
</div>
...
<?php $this->widget('AdminLinkPager', array('pages'=>$pager)) ?>
    ...
    <script>
        function set_sort(_this, id, sort){
            $.getJSON('<?php echo $this->createUrl('/admin/plot/ajaxPriceTagSort')?>',{id:id,sort:sort},function(dt){
