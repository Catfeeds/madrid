...
<div class="tabbale">
    ...
    <div class="tab-pane col-md-12 active" id="tab_1">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                <label class="col-md-2 control-label text-nowrap">备案名称</label>
                <div class="col-md-10">
                    <?php echo $form->textField($plot,'data_conf[recordname]',array('class'=>'form-control','data-target'=>'recordname'));?>
                    <span class="help-block"><?php echo $form->error($plot,'data_conf[recordname]');?></span>
                </div>
            </div>
