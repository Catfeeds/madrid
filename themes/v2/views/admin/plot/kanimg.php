...
<table class="table table-bordered table-striped table-condensed flip-content">
    ...
    <?php foreach($data as $v):?>
        <tr>
            ...
            <td style="text-align:center;vertical-align: middle">
                <?php echo CHtml::ajaxLink(PlotKanImgExt::$status[$v->status],$this->createUrl('ajaxKanImgStatus'), array('type'=>'post', 'data'=>array('id'=>$v->id, 'status'=>$v->status),'success'=>'function(data){location.reload()}'), array('class'=>'btn btn-sm '.PlotKanImgExt::$statusStyle[$v->status])); ?>
            </td>
            <td style="text-align:center;vertical-align: middle">
