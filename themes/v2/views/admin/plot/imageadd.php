...
?>
    <div class="portlet-body">
        ...
        <form role="form" class="form-horizontal" action="<?php echo Yii::app()->createUrl('/plot/imageadd/',array('hid'=>$hid))?>" method="post">
            ...
            <div class="form-body">
                ...
                <div class="row">
                    <div class="text-center col-md-offset-3 col-md-9">
                        ...
                        <?php echo CHtml::link('返回', $this->createUrl('plot/imagelist',array('hid'=>$hid)),array('class'=>'btn default'));
                        ?>
                    </div>
                </div>
