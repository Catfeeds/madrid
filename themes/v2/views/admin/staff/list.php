    ...
    <table class="table table-bordered table-striped table-condensed flip-content">
        <thead class="flip-content">
            <tr>
                ...
                <th width="20%" class="text-center">是否分配</th>
        ...
        <tbody>
            <?php foreach($data as $v): ?>
                <tr>
                    ...
                    <td class="text-center"><?php echo CHtml::ajaxLink($v->isWork, $this->createUrl('/admin/staff/ajaxChangeIsWork'), array('data'=>array('id'=>$v->id), 'type'=>'post', 'success'=>'function(d){if(d.code){location.reload();}else{toastr.error(d.msg)}}'),array('class'=>StaffExtraExt::$statusStyle[$v->isWork])); ?></td>
