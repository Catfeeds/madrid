    ...
    <div class="portlet-body">
        <div class="tabbable tabbable-tabdrop">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="#tab1" data-toggle="tab" aria-expanded="true">通用标签</a>
                </li>
                <li class="">
                    <a href="#tab2" data-toggle="tab" aria-expanded="false">住宅标签</a>
                </li> 
                <li class="">
                    <a href="#tab3" data-toggle="tab" aria-expanded="false">商铺标签</a>
                </li>
                <li class="">
                    <a href="#tab4" data-toggle="tab" aria-expanded="false">写字楼标签</a>
                </li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane active" id="tab1">
                    ...
                    <div class="portlet light bg-inverse ">
                        ...
                        <div class="portlet-body">
                            <?php foreach(TagExt::$resoldCate['direct'] as $catePinyin=>$cateName): if(in_array($catePinyin, $commonArr)):  ?>
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        ...
                                        <a href="<?=$this->createUrl('/admin/tag/resoldTagEdit',['cate'=>$catePinyin]); ?>" class="btn btn-default btn-sm"><i class="fa fa-pencil"></i>新增标签</a>
                                    </div>
                                </div>
                                    ...
                                    <?php if(isset($list[$catePinyin])): ?>
                                        <?php foreach($list[$catePinyin] as $v): ?><div class="btn-group" style="margin-bottom:5px;margin-right:5px;" data-id="<?=$v->id; ?>">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li><?=CHtml::link('编辑', ['/admin/tag/resoldTagEdit','id'=>$v->id]); ?></li>
                   ...
                   <!-- 区间式标签开始 -->
                    <div class="portlet light bg-inverse ">
                        ...
                        <div class="portlet-body">
                            <?php foreach(TagExt::$resoldCate['range'] as $catePinyin=>$cateName): if(in_array($catePinyin, $commonArr)): ?>
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-blue-hoki">
                                        <i class="fa fa-tag font-blue-hoki"></i><?php echo $cateName; ?>
                ...
                <div class="tab-pane" id="tab2">
                    ...
                    <div class="portlet light bg-inverse ">
                        ...
                        <div class="portlet-body">
                            <?php foreach(TagExt::$resoldCate['direct'] as $catePinyin=>$cateName): if(in_array($catePinyin, $zzArr['direct'])):  ?>
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-blue-hoki">
                                        <i class="fa fa-tag font-blue-hoki"></i><?php echo $cateName; ?>
                   ...
                   <!-- 区间式标签开始 -->
                    <div class="portlet light bg-inverse ">
                        ...
                        <div class="portlet-body">
                            <?php foreach(TagExt::$resoldCate['range'] as $catePinyin=>$cateName): if(in_array($catePinyin, $zzArr['between'])): ?>
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-blue-hoki">
                                        <i class="fa fa-tag font-blue-hoki"></i><?php echo $cateName; ?>
                ...
                <div class="tab-pane" id="tab3">
                    ...
                    <div class="portlet light bg-inverse ">
                        ...
                        <div class="portlet-body">
                            <?php foreach(TagExt::$resoldCate['direct'] as $catePinyin=>$cateName): if(in_array($catePinyin, $spArr['direct'])):  ?>
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-blue-hoki">
                                        <i class="fa fa-tag font-blue-hoki"></i><?php echo $cateName; ?>
                   ...
                   <!-- 区间式标签开始 -->
                    <div class="portlet light bg-inverse ">
                        ...
                        <div class="portlet-body">
                            <?php foreach(TagExt::$resoldCate['range'] as $catePinyin=>$cateName): if(in_array($catePinyin, $spArr['between'])): ?>
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-blue-hoki">
                                        <i class="fa fa-tag font-blue-hoki"></i><?php echo $cateName; ?>
                ...
                <div class="tab-pane" id="tab4">
                    ...
                    <div class="portlet light bg-inverse ">
                        ...
                        <div class="portlet-body">
                            <?php foreach(TagExt::$resoldCate['direct'] as $catePinyin=>$cateName): if(in_array($catePinyin, $xzlArr['direct'])):  ?>
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-blue-hoki">
                                        <i class="fa fa-tag font-blue-hoki"></i><?php echo $cateName; ?>
                   ...
                   <!-- 区间式标签开始 -->
                    <div class="portlet light bg-inverse ">
                        ...
                        <div class="portlet-body">
                            <?php foreach(TagExt::$resoldCate['range'] as $catePinyin=>$cateName): if(in_array($catePinyin, $xzlArr['between'])): ?>
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-blue-hoki">
                                        <i class="fa fa-tag font-blue-hoki"></i><?php echo $cateName; ?>
