...
<?php $form = $this->beginWidget('HouseForm',array('htmlOptions'=>array('class'=>'form-horizontal','onsubmit'=>'return checkForm(this);'),'enableAjaxValidation'=>false)) ?>
<style type="text/css">
    .right-text{
...
<div class="tabbale">
    ...
    <!-- <div class="tab-pane col-md-12 active" id="tab_1"> -->
        ...
        <div class="form-group">
                ...
                <div class="col-md-2"><?php echo $form->error($esf, 'username') ?></div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-2"><?php echo $form->error($esf, 'phone') ?></div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    ...
                    <?php echo $form->radioButtonList($esf, 'category',  ResoldEsfExt::$categories, array('class'=>'radio-inline', 'separator'=>'&nbsp;&nbsp;','template'=>'<label>{input} {label}</label>')); ?>
                    <span class="help-block"><?php echo $form->error($esf, 'category'); ?></span>
                    </div>
                </div>
                <div class="col-md-2"><?php echo $form->error($esf, 'category') ?></div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-10 zz esf_type" style="display: none">
                    ...
                    <span class="help-block"><?php echo $form->error($esf, 'tagsArr[0]'); ?></span>
                </div>
                <div class="col-md-10 sp esf_type" style="display: none">
                    ...
                    <span class="help-block"><?php echo $form->error($esf, 'tagsArr[1]'); ?></span>
                </div>
                <div class="col-md-10 xzl esf_type" style="display: none">
                    ...
                    <span class="help-block"><?php echo $form->error($esf, 'tagsArr[2]'); ?></span>
                </div>
            </div>
            ...
            <div class="form-group sp esf_type"  style="display: none">
                ...
                <div class="col-md-10">
                    ...
                    <span class="help-block"><?php echo $form->error($esf, 'esfspkjyxm'); ?></span>
                </div>
            </div>
            <div class="form-group sp esf_type"  style="display: none">
                ...
                <div class="col-md-10">
                    ...
                    <span class="help-block"><?php echo $form->error($esf, 'tagsArr[14]'); ?></span>
                </div>
            </div>
            <div class="form-group  xzl esf_type"  style="display: none">
                ...
                <div class="col-md-10">
                    ...
                    <span class="help-block"><?php echo $form->error($esf, 'tagsArr[15]'); ?></span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <?php echo $form->autocomplete($esf, 'hid', array('class'=>'form-control','data-init-text'=>$esf->hid ? $esf->plot_name : '','url'=>$this->createUrl('/admin/plot/ajaxGetHouse',['isNew'=>0]))); ?>
                    <span class="help-block"><?php echo $form->error($esf, 'hid'); ?></span>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-8">
                    ...
                    <span class="help-block"><?php echo $form->error($esf, 'address'); ?></span>
                </div>
                <div class="col-md-12"></div>
            </div>
            <div class="form-group">
                
                <label class="col-md-2 control-label text-nowrap"><?php if($esf->category!=2):?><span class="sp_hid" style="color: red">*&nbsp;</span><?php endif;?>所在楼层</label>
                <div class="col-md-8">
                <div class="col-md-2" style="padding-left: 0">
                    <?php echo $form->textField($esf,'floor',array('class'=>'form-control','value'=>$esf->floor?$esf->floor:'')); ?>
                    <span class="help-block"><?php echo $form->error($esf, 'floor'); ?></span>
                </div>
                <label class="col-md-1 control-label text-nowrap"><?php if($esf->category!=2):?><span class="sp_hid" style="color: red">*&nbsp;</span><?php endif;?>总楼层</label>
                <div class="col-md-2">
                    <?php echo $form->textField($esf,'total_floor',array('class'=>'form-control','value'=>$esf->total_floor?$esf->total_floor:'')); ?>
                    <span class="help-block"><?php echo $form->error($esf, 'total_floor'); ?></span>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <span class="help-block"><?php echo $form->error($esf, 'size'); ?></span>
                </div>
                <label class="col-md-1 control-label text-nowrap right-text">平方米</label>
                <div class="col-md-12"></div>
            </div>
           <div class="form-group zzpt peizhi">
                ...
                <div class="col-md-10">
                    ...
                    <span
                        class="help-block">
            <?php echo $form->error($esf, 'bedroom') . $form->error($esf, 'livingroom') . $form->error($esf, 'bathroom') ;?></span>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label text-nowrap"><span style="color: red">*&nbsp;</span>售价</label>
                <div class="col-md-3">
                    <?php echo $form->textField($esf,'price',array('class'=>'form-control','value'=>(int)$esf->price?$esf->price:'')); ?>
                    <span class="help-block">若售价为“0”则价格为“面议”</span>
                    <span class="help-block"><?php echo $form->error($esf, 'price'); ?></span>
                </div>
               ...
               <div class="form-group wyf" style="display: none">
                ...
                <div class="col-md-3">
                    ...
                    <span class="help-block"><?php echo $form->error($esf, 'wuye_fee'); ?></span>
                </div>
                <label class="col-md-1 control-label right-text">元/平方 </label>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-2">
                    ...
                    <span class="help-block"><?php echo $form->error($esf, 'age'); ?></span>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2"><?php echo $form->error($esf, 'decoration'); ?></div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-2"><?php echo $form->error($esf, 'towards'); ?></div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-12"><?php echo $form->error($esf, 'tagsArr[]'); ?></div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-10 zzts tese" style="display: none;">
                    <?php foreach ($zzpts as $key => $value) {?>
                       <input type="checkbox" name="tagsArr[7][]" value="<?=$value->id?>"><?=$value->name?></input>
                    <?php }?>
                </div>
                <div class="col-md-10 spts tese" style="display: none;">
                <?php foreach ($sppts as $key => $value) {?>
                       <input type="checkbox" name="tagsArr[8][]" value="<?=$value->id?>"><?=$value->name?></input>
                    <?php }?>
                </div>
                <div class="col-md-10 xzlts tese" style="display: none;">
                <?php foreach ($xzlpts as $key => $value) {?>
                       <input type="checkbox" name="tagsArr[9][]" value="<?=$value->id?>"><?=$value->name?></input>
                    <?php }?>
                </div>
                <div class="col-md-12"><?php echo $form->error($esf, 'tagsArr[]'); ?></div>
            </div>         
            <div class="form-group">
                ...
                <div class="col-md-8">
                    ...
                    <span class="help-block"><?php echo $form->error($esf, 'title'); ?></span>
                </div>
                <div class="col-md-2"><?php echo $form->error($esf, 'title') ?></div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label text-nowrap"><span style="color: red">*&nbsp;</span>房源描述</label>
                <div class="col-md-10">
                    <?php echo $form->textArea($esf,'content',array('id'=>'content')); ?>
                    <span class="help-block"><?php echo $form->error($esf, 'content'); ?></span>
                </div>
            </div>
            <!-- <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="hidden" value="<?=$this->createUrl('/admin/plot/AjaxGetImgs')?>" id="getImgs"></input>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                <div class="radio-list">
                    <?php echo $form->radioButtonList($esf, 'status',  Yii::app()->params['checkStatus'], array('class'=>'radio-inline', 'separator'=>'&nbsp;&nbsp;','template'=>'<label>{input} {label}</label>')); ?>
                    <span class="help-block"><?php echo $form->error($esf, 'status'); ?></span>
                    </div>
                </div>
            </div>
            <?php endif;?>
...
<script type="text/javascript">
    ...
    {
        // var arr = [];
        // $('input[name^="ResoldEsfExt"][type="radio"]:checked,input[name^="ResoldEsfExt"][type="checkbox"]:checked,[name^="ResoldEsfExt"][type="hidden"],select[name^="ResoldEsfExt"],input[name^="ResoldEsfExt"][type="text"]').each(function(k,o){

        //     var id = o.id;
        //     var index = id.indexOf('_');
        //     var key = id.slice(index+1);
        //     var value = $(o).val(); 
        //     if(id.indexOf('_tags') == -1 && value.length > 0){
        //         arr.push({
        //             key : 'ResoldEsfExt['+key+']',
        //             value : value
        //         });
        //     }
        // })
        // $.ajax({
        //     type:'get',
        //     url:'<?=$this->createUrl('/admin/common/ajaxCheckFields')?>',
        //     data:{arr},
        //     dataType:'json',
    ...
    function checkPhone() {
       ...
       $.ajax({
            ...
            data:{phone:$('#ResoldEsfExt_phone').val(),type:'1'},
            dataType:'json',
            success:function(data){
                if(data.data=="1")
