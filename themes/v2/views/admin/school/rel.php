...
<div class="portlet box blue-hoki">
    ...
    <div class="portlet-body">
        <div data-rail-visible="1" data-rail-color="yellow" data-handle-color="#a1b2bd" >
            ...
            <?php echo CHtml::ajaxButton('保存所选', $this->createUrl('ajaxGetPlot'), array('data' => array('ids' => 'js:getPlotClass()', 'sid' => $id), 'type' => 'post','success'=>'function(data){if(data.code){location.reload()}else{toastr.error(data.msg)}}'), array('class' => 'btn btn-success btn-sm blue')); ?>
        </div>
    </div>
</div>
