        ...
        <fieldset>
            ...
            <div class="base-info">
                <div class="inner">
                    ...
                    <!-- 写字楼级别 -->
                    <div class="formitm">
                        <label class="lab"><span class="re"></span> 写字楼级别</label>
                        <div class="ipt">
                        <?php $splevel = $esf->getEsfTag('xzllevel');?>
                            <ul class="radio-list f-cb">
                            <?php if($typeArr = CHtml::listData(TagExt::model()->getTagByCate('zfxzllevel')->normal()->findAll(),'id','name')) foreach ($typeArr as $key => $value) { ?>
