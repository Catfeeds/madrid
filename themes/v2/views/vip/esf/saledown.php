    ...
    <?php foreach($list as $k=>$v): ?>
        <tr>
            ...
            <td style="text-align:center;vertical-align: middle">
                ...
                <?php
                    echo CHtml::ajaxLink('上架',$this->createUrl('onSale'),array('type'=>'get','data'=>['fids'=>$v->id],'success'=>'function(){location.reload()}'),['class'=>"btn btn-xs blue"])
                ?>
                <?php
...
<div class="form-group">
    ...
    <?php echo CHtml::ajaxButton('上架所选', $this->createUrl('onSale'), array('data'=>array('fids'=>'js:getChecked()'),'type'=>'post', 'success'=>'function(data){location.reload()}', 'beforeSend'=>'function(){if(!getChecked()){toastr.error("请至少选择一项！");return false;}}'), array('class'=>'btn btn-success btn-sm')); ?>
