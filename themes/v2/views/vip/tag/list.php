            ...
            <div class="portlet-body">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <?php echo CHtml::ajaxLink('一键禁用', $this->createUrl('/vip/tag/ajaxStatus'), ['data'=>['cate'=>$catePinyin,'status'=>1], 'type'=>'post', 'success'=>'js:function(d){if(d.code){location.reload();}else{toastr.error(d.msg);}}'],['class'=>'btn btn-default btn-sm']); ?>
                            <?php echo CHtml::ajaxLink('一键启用', $this->createUrl('/vip/tag/ajaxStatus'), ['data'=>['cate'=>$catePinyin,'status'=>0], 'type'=>'post', 'success'=>'js:function(d){if(d.code){location.reload();}else{toastr.error(d.msg);}}'],['class'=>'btn btn-default btn-sm']); ?>

                            <a href="<?=$this->createUrl('/vip/tag/edit',['cate'=>$catePinyin]); ?>" class="btn btn-default btn-sm"><i class="fa fa-pencil"></i>新增标签</a>
                        </div>
                    </div>
