    ...
    <?php foreach($news as $k=>$v): ?>
        <tr>
            ...
            <td style="text-align:center;vertical-align: middle">
                <a href="<?php echo $this->createUrl('/vip/news/edit',array('id'=>$v->id)); ?>" class="btn default btn-xs green"><i class="fa fa-edit"></i> 修改 </a>
...
<?php Tools::startJs(); ?>
    ...
    function set_sort(_this, id, sort){
            $.getJSON('<?php echo $this->createUrl('/vip/news/ajaxSort')?>',{id:id,sort:sort},function(dt){
                location.reload();
            });
        }
    function do_sort(ts){
