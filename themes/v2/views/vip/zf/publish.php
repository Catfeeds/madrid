    ...
    <div class="tab-content col-md-12" style="padding-top:20px;">
        <div class="col-md-10">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <?php echo $form->autocomplete($zf, 'hid', array('class' => 'form-control', 'data-init-text' => $zf->hid ? $zf->plot->title : $zf->plot_name, 'url' => $this->createUrl('/vip/common/ajaxGetHouse',['isNew'=>0]))); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <?php echo $form->textField($zf,'price',array('class'=>'form-control','value'=>(int)$zf->price?$zf->price:0)); ?>
                    <span class="help-block">若售价为“0”则价格为“面议”</span>
                    <span class="help-block"></span>
                </div>
                <label class="col-md-1 control-label right-text">元/月 </label>
            </div>
            ...
            <div class="form-group" id="zfzzts">
                ...
                <div class="col-md-10">
                    <?php echo $form->checkBoxList($zf, 'zfzzts', CHtml::listData(TagExt::model()->getTagByCate('zfzzts')->normal()->findAll(['order'=>'sort asc']), 'id', 'name'), array('class' => 'checkbox-inline', 'separator' => '&nbsp;&nbsp;', 'template' => '<label>{input} {label}</label>','onclick'=>'limitTs(this)')); ?>
                </div>
            </div>
            ...
            <div class="form-group" id="zfspts">
                ...
                <div class="col-md-10">
                    <?php echo $form->checkBoxList($zf, 'zfspts', CHtml::listData(TagExt::model()->getTagByCate('zfspts')->normal()->findAll(['order'=>'sort asc']), 'id', 'name'), array('class' => 'checkbox-inline', 'separator' => '&nbsp;&nbsp;', 'template' => '<label>{input} {label}</label>','onclick'=>'limitTs(this)')); ?>
                </div>
            </div>
            <div class="form-group" id="zfxzlts">
                <label class="col-md-2 control-label text-nowrap">租房写字楼特色</label>
                <div class="col-md-10">
                    <?php echo $form->checkBoxList($zf, 'zfxzlts', CHtml::listData(TagExt::model()->getTagByCate('zfxzlts')->normal()->findAll(['order'=>'sort asc']), 'id', 'name'), array('class' => 'checkbox-inline', 'separator' => '&nbsp;&nbsp;', 'template' => '<label>{input} {label}</label>','onclick'=>'limitTs(this)')); ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="hidden" value="<?= $this->createUrl('/vip/common/AjaxGetImgs') ?>" id="getImgs"/>
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-5 col-md-9">
                        ...
                        <?php echo CHtml::link('返回', Yii::app()->createUrl('vip/zf/saleUp'), array('class' => 'btn default')) ?>
                    </div>
                </div>
            </div>
        </div>
