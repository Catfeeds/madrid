...
<div class="table-toolbar">
    <div class="btn-group pull-left">
        <form class="form-inline">
            ...
            <div class="form-group">
                <?php echo CHtml::dropDownList('xl',$xl,$xls,array('class'=>'form-control chose_select','encode'=>false,'prompt'=>'--选择系列--')); ?>
            </div>
            <div class="form-group">
                <?php echo CHtml::dropDownList('ptpz',$ptpz,$ptpzs,array('class'=>'form-control chose_select','encode'=>false,'prompt'=>'--葡萄品种--')); ?>
            </div>
            <div class="form-group">
                <?php echo CHtml::dropDownList('house',$house,$houses,array('class'=>'form-control chose_select','encode'=>false,'prompt'=>'--选择酒庄--')); ?>
            </div>
   ...
   <table class="table table-bordered table-striped table-condensed flip-content table-hover">
    ...
    <?php foreach($list as $k=>$v): ?>
        ...
        <td style="text-align:center;vertical-align: middle" class="warning sort_edit"
            ...
            <td class="text-center"><?=TagExt::getNameByTag($v->xl)?></td>
            <td class="text-center"><?=TagExt::getNameByTag($v->ptpz)?></td>
            <td class="text-center"><?=$v->houseInfo?$v->houseInfo->name:'无'?></td>            
            ...
            <td style="text-align:center;vertical-align: middle">
                <a href="<?php echo $this->createUrl('/vip/product/edit',array('id'=>$v->id)); ?>" class="btn default btn-xs green"><i class="fa fa-edit"></i> 修改 </a>
...
<?php Tools::startJs(); ?>
    ...
    function set_sort(_this, id, sort){
            $.getJSON('<?php echo $this->createUrl('/vip/product/ajaxSort')?>',{id:id,sort:sort},function(dt){
                location.reload();
            });
        }
    function do_sort(ts){
