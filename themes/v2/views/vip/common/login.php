...
<head>
<meta charset="utf-8"/>
<title><?php echo $this->pageTitle='常州马德里公馆后台' ?></title>
...
<div class="logo" style="height: 50px">
    <!-- <img src="/static/admin/layout/img/logo-wine.png" width="20px" height="20px" alt=""/> -->
</div>
<!-- END LOGO -->
...
<div class="content ">
	...
	<form class="login-form" action="" method="post">
		<h3 class="form-title" style="font-family: 微软雅黑">马德里公馆系统管理后台</h3>
...
Layout.init(); // init current layout
  ...
  Demo.init();
       ...
       $.backstretch([
        "/static/admin/layout/img/wine-bg.jpg",
        "/static/admin/layout/img/wine-bg2.jpg",
        "/static/admin/layout/img/wine-bg3.jpg",
        ], {
          fade: 1000,
          duration: 3000
    }
