    ...
    <div class="wapper">
        <div class="main-left">
            <div class="next-tabs clearfix">
                ...
                <ul class="clearfix">
                  <li><a href="<?=$this->createUrl('esfList',['staff'=>$staff->id])?>">二手房</a></li>
                  <li><a href="<?=$this->createUrl('zfList',['staff'=>$staff->id])?>" class="active">租房</a></li>               
                </ul>
            </div>
            <div class="sort">
                ...
                <div class="filter fr mt8">
                    <div class="fl paixu">
                        <p>排序：<a href="<?=$this->createUrl('zflist',['staff'=>$get['staff'],'sort'=>'1'])?>" class="<?=$get['sort']==1?'on':''?>">按更新时间</a>
                            <a href="<?=$this->createUrl('zflist',['staff'=>$get['staff'],'sort'=>'2'])?>" class="<?=$get['sort']==2?'on':''?>">按发布时间</a></p>
                    </div>
                    <div class="pr fl">
                        <a href="<?=$this->createUrl('zflist',['staff'=>$get['staff'],'sort'=>$get['sort']==3?4:3])?>" class="sort-btn price-btn sort-<?=$get['sort']==4?'up':'down'?> <?=($get['sort']==4 || $get['sort']==3)?'on':'fr'?>">租金<i></i></a>
                    ...
                    <div class="pr fl">
                        <a href="<?=$this->createUrl('zflist',['staff'=>$get['staff'],'sort'=>$get['sort']==5?6:5])?>" class="sort-btn size-btn sort-<?=$get['sort']==6?'up':'down'?> <?=($get['sort']==5 || $get['sort']==6)?'on':'fr'?>">面积<i></i></a>
                        <div class="tips-notice">
                    ...
                    <li class="item clearfix">
                        ...
                        <div class="content fl">
                            ...
                            <div class="about-price">
                                  ...
                                  <!-- <p class="tag"><?=isset($v->wuye_fee)?$v->wuye_fee:"-"?>元/㎡</p> -->
                             </div>
                        </div>
                    </li>
                   <?php }?>
        ...
        <div class="main-right mt47">
            <div class="frame side-box">
                ...
                <?php $this->widget('StaffRightWidget',['uid'=>$staff->uid,'type'=>2]);?>
                <div class="dotted-line"></div>
                <?php $this->widget('StaffRightWidget',['uid'=>$staff->uid,'category'=>2,'type'=>2]);?>
                <div class="dotted-line"></div>
                <?php $this->widget('StaffRightWidget',['uid'=>$staff->uid,'category'=>3,'type'=>2]);?>
            </div>
