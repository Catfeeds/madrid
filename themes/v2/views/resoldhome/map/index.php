...
?>
    <script type="text/javascript">
        ...
        var is_open_street = '<?=SM::resoldConfig()->resoldIsOpenStreet()?>';
    </script>
<div class="wapper-out search-wrap clearfix">
    <div class="search-box clearfix">
        <form method="get" id="search-form" action="<?=$type==1?$this->createUrl('/resoldhome/esf/list'):$this->createUrl('/resoldhome/zf/list')?>">
        <div class="search-input fl">
            <input class="input" name="kw" value="" placeholder="<?=$type==1?'请输入二手房名称':'请输入租房名称'?>">
        </div>
    ...
    <div class="select-box map-select-box">
       <div class="left-box">
        ...
        <div class="right-box">
            ...
            <a href="<?=$type==1?$this->createUrl('/resoldhome/esf/list'):$this->createUrl('/resoldhome/zf/list')?>"><div class="right-list">列表</div></a>
        </div>
    </div>
</div>
<div class="blank20"></div>
