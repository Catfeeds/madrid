    ...
    <div class="b3 my-edit-params">
        ...
        <div class="form">
            <div class="ele ele-name ele-input">
                ...
                <div class="option">
                    <input type="hidden" class="u-input form-control js-plot-select2" value="<?php echo $model->hid; ?>" data-name="<?php echo $model->plot->title ;?>" name="hid" datatype="n" errormsg="无法找到小区" nullmsg="请输入小区名称" />
            ...
            <div class="ele ele-select display-1 <?php if($model->category != 1){echo 'dn';}?>" >
                ...
                <div class="option">
                    <select name="tags[]" data-width="197">
                        <?php foreach($this->allTag['esfzfzztype'] as $type): ?>
                            <option value="<?php echo $type['id'];?>" <?php echo isset($model->data_conf['esfzfzztype'][$type['id']]) ? 'selected':''; ?>><?php echo $type['name']; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            ...
            <div class="ele ele-input">
                ...
                <div class="option">
                    <input class="u-input w68" type="text" name="size" value="<?php echo $model->size;?>" datatype="size" nullmsg="请输入产证面积" errormsg="产证面积要大于1平方米小于10000平方米"/><span class="unit">平方米</span>
                    <div class="ui-errormsg"></div>
                </div>
            </div>
            <div class="ele total-price ele-input">
                ...
                <div class="option">
                    <input class="u-input" type="text" name="price" value="<?php echo $model->price;?>" datatype="price" nullmsg="请输入价格" errormsg="价格必须在0到100000之间" /><span class="unit">万元</span><span class="unit">（输入0元显示为面议）</span>
                    <div class="ui-errormsg"></div>
                </div>
            </div>
            <div class="ele ele-input">
            ...
            <div class="ele ele-huxing ele-input display-1" <?php if($model->category != 1){echo 'style="display:none"';}?>>
                <div class="label"><span class="em">*</span> 户<span class="em2"></span>型</div>
                <div class="option">
                    <!-- datatype="n" nullmsg="请输入几室" errormsg="请输入数字" -->
                ...
                <div class="option">
                    <ul>
                        <?php foreach ($this->allTag['esfspkjyxm'] as $ts): ?>
                            <li><label><input datatype="jyxm" nullmsg="请选择经营项目" type="checkbox" name="esfspkjyxm[]" value="<?php echo $ts['id'];?>" <?php echo isset($model->data_conf['esfspkjyxm'][$ts['id']]) ? 'checked':''; ?>/><?php echo $ts['name']?></label></li>
                        <?php endforeach; ?>
                        <div class="ui-errormsg"></div>
                    </ul>
                </div>
            ...
            <div class="ele ele-input <?php if($model->category == 1){echo 'dn';}?>" id="wuye-fee">
                ...
                <div class="option">
                    <input class="u-input w98" type="text" value="<?php echo $model->wuye_fee; ?>" name="wuye_fee" /><span class="unit">元/平方米·月</span>
                </div>
            </div>
            ...
            <div class="ele ele-select">
                ...
                <select name="age">
                    ...
                    <?php for($i=date('Y');$i>=(date('Y')-20);$i--): ?>
                        <option value="<?php echo $i;?>" <?php if($model->age == $i){echo 'selected';} ?>><?php echo $i; ?></option>
                    <?php endfor; ?>
            ...
            <div class="ele ele-select display-2 <?php if($model->category != 2){echo 'dn';}?>" >
                ...
                <select name="tags[]">
                    ...
                    <?php foreach($this->allTag['esfsplevel'] as $splevel): ?>
                        <option value="<?php echo $splevel['id'];?>" <?php echo isset($model->data_conf['esfsplevel'][$splevel['id']]) ? 'selected':''; ?>><?php echo $splevel['name']; ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="ele ele-select display-3 <?php if($model->category != 3){echo 'dn';}?>">
                ...
                <select name="tags[]">
                    ...
                    <?php foreach($this->allTag['zfxzllevel'] as $xzllevel): ?>
                        <option value="<?php echo $xzllevel['id'];?>" <?php echo isset($model->data_conf['zfxzllevel'][$xzllevel['id']]) ? 'selected':''; ?>><?php echo $xzllevel['name']; ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            ...
            <div class="ele multi-checkbox mb0 display-1 <?php if($model->category != 1){echo 'dn';}?>" >
                ...
                <div class="option">
                    <ul>
                        <?php foreach ($this->allTag['esfzzts'] as $ts): ?>
                            <li><label><input datatype="ts" errormsg="特色最多可选择5个"  type="checkbox" name="tags[]" value="<?php echo $ts['id'];?>" <?php echo isset($model->data_conf['esfzzts'][$ts['id']]) ? 'checked':''; ?>/><?php echo $ts['name']?></label></li>
                        <?php endforeach; ?>
                        <div class="ui-errormsg"></div>
                    </ul>
                </div>
            ...
            <div class="ele multi-checkbox mb0 display-2 <?php if($model->category != 2){echo 'dn';}?>" >
                ...
                <div class="option">
                    <ul>
                        <?php foreach ($this->allTag['esfspts'] as $ts): ?>
                            <li><label><input datatype="ts" errormsg="特色最多可选择5个"  type="checkbox" name="tags[]" value="<?php echo $ts['id'];?>" <?php echo isset($model->data_conf['esfspts'][$ts['id']]) ? 'checked':''; ?>/><?php echo $ts['name']?></label></li>
                        <?php endforeach; ?>
                        <div class="ui-errormsg"></div>
                    </ul>
                </div>
            ...
            <div class="ele multi-checkbox mb0 display-3 <?php if($model->category != 3){echo 'dn';}?>" >
                ...
                <div class="option">
                    <ul>
                        <?php foreach ($this->allTag['esfxzlts'] as $ts): ?>
                            <li><label><input datatype="ts" errormsg="特色最多可选择5个"  type="checkbox" name="tags[]" value="<?php echo $ts['id'];?>" <?php echo isset($model->data_conf['esfxzlts'][$ts['id']]) ? 'checked':''; ?>/><?php echo $ts['name']?></label></li>
                        <?php endforeach; ?>
                        <div class="ui-errormsg"></div>
                    </ul>
                </div>
