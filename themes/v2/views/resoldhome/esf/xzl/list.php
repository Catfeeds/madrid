     ...
     <div class="big-filter">
        ...
        <div class="category-select">
            ...
            <dl class="clearfix">
              <dt>级别：</dt>
              <dd>
                <?php $this->widget('TagInfoWidget',['cate'=>'zfxzllevel','id'=>$get['level'],'get'=>$_GET,'url'=>'/resoldhome/esf/list'])?>
              </dd>
            </dl>
            <dl class="clearfix">
              <dt>特色：</dt>
        ...
        <div class="main-left">
            <div class="next-tabs clearfix">
                ...
                <ul class="clearfix">
                    <li><a href="<?=$this->createUrl('/resoldhome/esf/list',['type'=>3])?>" class="<?=!$get['source']&&!$get['hurry']?'active':''?>">在售写字楼</a></li>
                    <li><a href="<?=$this->createUrl('/resoldhome/zf/list',['type'=>3])?>" class="<?=$get['source']==1?'active':''?>">在租写字楼</a></li>
                    <li><a href="<?=$this->createUrl('list',['source'=>1,'type'=>3])?>" class="<?=$get['source']==1?'active':''?>">个人房源</a></li>
                    <li><a href="<?=$this->createUrl('list',['hurry'=>1,'type'=>3])?>" class="<?=$get['hurry']==1?'active':''?>">急售房源</a></li>
                </ul>
            </div>
            <div class="sort">
                <span>找到<em class="c-main"><?=$esfNum?></em>套写字楼</span>
            ...
            <ul class="item-list">
                    ...
                    <li class="item clearfix">
                        ...
                        <div class="content fl">
                            ...
                            <p class="area"><a href="<?=$this->createUrl('list',['area'=>$v->area,'type'=>3])?>"><?=$v->areaInfo->name?></a><span class="maps"><?=$v->streetInfo->name?></span></p>
                            <p class="detail"><span>等级：<?=isset($v->getEsfTag()['xzllevel'])?$v->getEsfTag()['xzllevel']['name']:''?></span><em>|</em><span><?=isset($v->getEsfTag()['floorcate'])?$v->getEsfTag()['floorcate']['name']:$v->floor?>/<?=$v->total_floor?>层</span></p>
                            <p class="agents">
