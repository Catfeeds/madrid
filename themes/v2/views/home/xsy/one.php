            ...
            <div class="box_right">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <?php foreach($this->siteTag as $k=>$v):?>
                            <?php if($v->cate=='xinfangjiage'):?>
                                <a href="<?php echo $this->urlConstructor->add('price', $v->id); ?>" title="<?php echo $v->name;?>" target="_blank"><?php echo $v->name;?></a>
                            <?php endif;?>
                        <?php endforeach;?>
                    </li>
                    <li>
                        <span class="fw gc3 fs14 mr10">特色</span>
