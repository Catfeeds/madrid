    ...
    <div class="label_box">
        ...
        <div class="loupan_detail">
            <dl>
                ...
                <dd>
                    <p><a href="<?php echo $this->createUrl('/home/plot/index',array('py'=>$plot->pinyin)); ?>" target="_blank" class="fs22 bigfs c-g3"><?php echo $plot->title; ?></a><span class="fs14 ml15"><a href="<?php echo $this->createUrl('/home/plot/detail', array('py'=>$plot->pinyin)); ?>" target="_blank" class="c_link mr5">详情</a>|<a href="<?php echo $this->createUrl('/home/plot/huxing', array('py'=>$plot->pinyin)); ?>" target="_blank" class="c_link ml5 mr5">户型</a><?php if($plot->old_id&&SM::pageUrlConfig()->homePlotIndexEsfListUrl()||$plot->data_conf['esfUrl']): ?>|<a href="<?php echo $plot->data_conf['esfUrl']?$plot->data_conf['esfUrl']:str_replace('{id}',$plot->old_id,SM::pageUrlConfig()->homePlotIndexEsfListUrl()); ?>" target="_blank" class="c_link ml5 mr5">二手房</a><?php endif; ?><?php if($plot->old_id&&SM::pageUrlConfig()->homePlotIndexEsfListUrl()||$plot->data_conf['zfUrl']): ?>|<a href="<?php echo $plot->data_conf['zfUrl']?$plot->data_conf['zfUrl']:str_replace('{id}',$plot->old_id,SM::pageUrlConfig()->homePlotIndexZfListUrl()); ?>" target="_blank" class="c_link ml5">租房</a></span><?php endif; ?></p>
