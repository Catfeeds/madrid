...
$this->breadcrumbs = array(SM::urmConfig()->cityName().'看房团');
?>
    ...
    <div class="house-sale-notice">
        <div class="text-box">
            ...
            <div class="text-right">
                ...
                <p>看房团热线：<span class="c-ored"><?php echo SM::GlobalConfig()->sitePhone()?></span></p>
            </div>
        ...
        <div class="baomingform clearfix">
            <div class="fl left">
                ...
                <div class="t3">免费报名电话&#160;<?php echo SM::GlobalConfig()->sitePhone()?></div>
                <ul class="fuwu">
        ...
        <div class="beback">
            <div class="mtitle" >精彩回顾<a href="<?php echo $this->createUrl('/home/tuan/back')?>" target="_blank" class="fr c-g9 fs14 mt10" >更多精彩回顾</a></div>
            <ul class="clearfix">
