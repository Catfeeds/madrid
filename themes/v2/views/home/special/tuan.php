...
$this->breadcrumbs = array(SM::urmConfig()->cityName().$this->t('特惠团'));
?>
<div class="wapper">
    ...
    <div class="group-list">
        ...
        <dl class="clearfix">
            <dt><a href="<?php echo $v->url ? $v->url : $this->createUrl('/home/plot/index',array('py'=>$v->plot->pinyin))?>" target="_blank"><img class="lazy" data-original="<?php echo ImageTools::fixImage($v->pc_img,580,346)?>"></a><span class="ad-lab">广告</span></dt>
            <dd>
