...
<div id="sitecontent">
        <div class="npagePage Pageyemian" id="page_none">
            <div id="banner">
                <div style="background-image:url(<?=ImageTools::fixImage(SiteExt::getAttr('qjpz','pcContactTop'),1200,400)?>);"></div>
            </div>
            <div class="content">
                <div class="header">
                    <p class="title">联系</p>
                ...
                <div class="fw postbody">
                    <p style="padding: 0px; font-family: Arial,微软雅黑; white-space: normal; line-height: 2.5em; text-align: center;">WEB极速建站是旗下产品。我们用10几年的高端企业网站定制服务，曾服务过：海尔、联想、北京电通、BIAD、雅虎、凤凰中心、民生银行等尽400多家高端企业用户。</p>
